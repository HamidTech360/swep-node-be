...
const { getAllProfiles: getAllStageOneProfiles, getStats: getStageOneStats } = require('../stage_one_vp/stage_one_vp.controllers')
const { getAllProfiles: getAllStageTwoProfiles, getStats: getStageTwoStats } = require('../stage_two_vp/stage_two_vp.controllers')
...
router.get('/stage_one_vp/stats', getStageOneStats )
router.get('/stage_two_vp/stats', getStageTwoStats )
